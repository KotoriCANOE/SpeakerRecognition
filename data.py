...
class Data:
    ...
    @staticmethod
    def extract_batch(batch_set, num_labels):
        # parameters
        sample_rate = 16000
        slice_duration = 2000
        ...
        with ProcessPoolExecutor(self.threads) as executor:
            ...
            for epoch in range(start // self.epoch_steps, self.num_epochs):
                ...
                for step in range(step_start, step_stop):
                    ...
                    futures.append(executor.submit(self.extract_batch, batch_set, self.out_channels))
    ...
    def get_val(self):
        return self.extract_batch(self.val_set, self.out_channels)
